...
Webflow.require('ix').init([
  {"slug":"hover-over-hero-image","name":"Hover Over Hero Image","value":{"style":{},"triggers":[{"type":"hover","selector":".hero-img-hover","descend":true,"stepsA":[{"opacity":1,"wait":0}],"stepsB":[{"opacity":0,"transition":"opacity 350ms ease 0ms"}]},{"type":"hover","selector":".hero-img","descend":true,"stepsA":[{"opacity":0.5}],"stepsB":[{"opacity":1,"transition":"opacity 350ms ease 0ms"}]}]}},
